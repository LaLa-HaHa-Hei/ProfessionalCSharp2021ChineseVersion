...
如今，每年都会发布一个新版本的 C\#，C\# 8 加入了 可空引用类型，C\# 9 加入了 records 等等，C\# 10 和 .NET 6 在 2021 年发布，C\# 11 和 .NET 7 在 2022 年发布。因为如今变更频繁，查看本书的 GitHub 仓库（详见“源代码”一节）以获取持续更新。

\section*{C\# 的新东西}
\pdfbookmark[1]{C\# 的新东西}{0.3}
...
\pdfbookmark[1]{ASP.NET CORE 的新东西}{0.4}
...
\pdfbookmark[1]{Windows 的新东西}{0.5}
...
\pdfbookmark[1]{你需要用什么编写和运行 C\# 代码}{0.6}
...
\subsection*{第一部分，“C\# 语言”}
% \pdfbookmark[2]{第一部分，“C\# 语言”}{0.7.1}
